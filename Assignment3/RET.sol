...
contract RoyalEntryToken {
    string public name = "Royal Entry Token"; // Name of the token
    string public symbol = "RET"; // Symbol of the token
    string public standard = "Royal Entry Token v1.0"; // Standard of the token
